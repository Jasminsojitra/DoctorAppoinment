...
class LapManagement extends StatefulWidget {
  const LapManagement() : super();

  @override
  _hospitalManagementState createState() => _hospitalManagementState();
}

class _hospitalManagementState extends State<LapManagement> {
