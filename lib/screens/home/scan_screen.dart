...
class ScanScreen extends StatefulWidget {
  ...
  @override
  _ScanScreenScreenState createState() => _ScanScreenScreenState();
}

class _ScanScreenScreenState extends State<ScanScreen> {
  double valueKm = 0;
  List<Hospital>? scanList;
  ...
  Future<List<Hospital>> getAllScan() async {
    QuerySnapshot qShot =
  ...
  getAllscanList() async {
    await getAllScan().then((value) => scanList=value);
    setState(() {});
  }
        ...
        child: Container(
          ...
          child: ListView(
            children: [
                          ...
                          children: [
                            ...
                            RichText(
                              text: TextSpan(
                                ...
                                children: [
                                  TextSpan(text: "249 Scan Center, ",style: GoogleFonts.montserrat(
                                    fontSize: 12,
              ...
              //* --------------------------------
              ScanList(
                scanList: (scanList!=null && scanList!.length>0)?scanList! : cachedHospitalList,
              ),
            ],
          ),
        ),
